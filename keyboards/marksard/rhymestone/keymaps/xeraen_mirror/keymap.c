...
RGUI_T(KC_SCLN),RALT_T(KC_L),RCTL_T(KC_K),RSFT_T(KC_J),KC_H,KC_G,SFT_T(KC_F),CTL_T(KC_D),ALT_T(KC_S),GUI_T(KC_A),
KC_SLSH,KC_DOT,KC_COMM,KC_M,KC_N,KC_B,KC_V,KC_C,KC_X,KC_Z,
TO(CAGS),TO(MACOS),CW_TOGG,KC_ENT,LT(SYMBOLS, KC_SPC),LT(NUMBERS, KC_BSPC),LT(NAV, KC_TAB),LT(FUNCTION,KC_SPC),TO(MACOS),TO(CAGS)
  //,----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------.
...
KC_P,KC_O,KC_I,KC_U,KC_Y,KC_T,KC_R,KC_E,KC_W,KC_Q,
RCTL_T(KC_SCLN),RALT_T(KC_L),RGUI_T(KC_K),RSFT_T(KC_J),KC_H,KC_G,SFT_T(KC_F),GUI_T(KC_D),ALT_T(KC_S),CTL_T(KC_A),
KC_SLSH,KC_DOT,KC_COMM,KC_M,KC_N,KC_B,KC_V,KC_C,KC_X,KC_Z,
TO(CAGS),TO(MACOS),CW_TOGG,KC_ENT,LT(SYMBOLS, KC_SPC),LT(NUMBERS, KC_BSPC),LT(NAV, KC_TAB),LT(FUNCTION,KC_SPC),TO(MACOS),TO(CAGS)
  //,----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------.
// KC_Q,KC_W,KC_E,KC_R,KC_T,KC_Y,KC_U,KC_I,KC_O,KC_P,
...
KC_ESC,KC_ESC,KC_RIGHT_ANGLE_BRACKET,KC_LEFT_ANGLE_BRACKET,KC_PLUS,KC_ASTERISK,KC_RIGHT_CURLY_BRACE,KC_LEFT_CURLY_BRACE,KC_HASH,KC_TILDE,
KC_COLON,KC_GRV,KC_QUOTE,KC_DOUBLE_QUOTE,KC_EQUAL,KC_MINUS,KC_RIGHT_PAREN,KC_LEFT_PAREN,KC_DOLLAR,KC_AT,
KC_NO,KC_INS,KC_BACKSLASH,KC_AMPERSAND,KC_PERCENT,KC_PIPE,KC_RIGHT_BRACKET,KC_LEFT_BRACKET,KC_CIRCUMFLEX,KC_EXCLAIM,
KC_NO,KC_NO,KC_NO,KC_NO,KC_UNDERSCORE,KC_UNDERSCORE,KC_DEL,XPW,KC_NO,KC_NO
  //,------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------.
...
KC_PLUS,KC_9,KC_8,KC_7,KC_7,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,
KC_PLUS,KC_6,KC_5,KC_4,KC_4,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,
KC_PLUS,KC_3,KC_2,KC_1,KC_1,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,
KC_ENTER,KC_DOT,KC_0,KC_0,KC_0,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO
/*
...
KC_NO,KC_RIGHT,KC_UP,KC_DOWN,KC_LEFT,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,
KC_END,KC_PAGE_UP,KC_PAGE_DOWN,KC_HOME,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,
KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO
/*
  KC_NO, KC_NO, KC_NO, KC_NO, KC_NO, KC_NO,   KC_NO,    KC_NO,        KC_NO,      KC_NO,
...
KC_F12,KC_F11,KC_F10,KC_F9,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,
KC_F8,KC_F7,KC_F6,KC_F5,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,
KC_F4,KC_F3,KC_F2,KC_F1,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,
KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO,KC_NO
/*
  ...
  switch (keycode) {
    case XPW:
      if (record->event.pressed) {
        SEND_STRING("notreallyanythingatall");
      }
      break;
